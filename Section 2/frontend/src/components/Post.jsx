    ...
    <div className='container p-5'>
      <div className="card mb-3">
        ...
        <p className='container align-items m-0'>
          ...
          <i className="fa-regular fa-2x fa-comment p-2" onClick={() => {setcomment(comment+1)}}></i>
        ...
        <div className="card-body pt-2">
          <b>{Likes} Likes</b>
          <h6 className="card-title py-2">@_khushi353_</h6>
          ...
          <p className="card-text">
            <p className='my-com'>View all {comment} comments</p>
            <small className="text-muted upd">Last updated 3 mins ago</small>
          </p>
        </div>
      </div>
